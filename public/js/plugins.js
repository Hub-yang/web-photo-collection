      ...
      if (!l.$slide.eq(c).hasClass('lg-loaded')) {
        if (q)
          ...
          r
            ...
            : l.$slide
                .eq(c)
                .prepend('<div class="lg-img-wrap"><img class="lg-object lg-image" src="' + g + '" /></div>')
        if (
        ...
        if (!f.lgBusy) {
          if (this.s.download) {
            ...
            ;(k = f.s.dynamic
              ...
              k
                ? (a('#lg-download').attr('href', k), f.$outer.removeClass('lg-hide-download'))
          ...
          if (
            ...
            f.$outer.addClass('lg-no-trans'),
              ...
              j
                ? (this.$slide.eq(b).addClass('lg-prev-slide'), this.$slide.eq(e).addClass('lg-next-slide'))
                : i && (this.$slide.eq(b).addClass('lg-next-slide'), this.$slide.eq(e).addClass('lg-prev-slide')),
              setTimeout(function () {
...
!(function (e, o, i, l) {
  ...
  ;(s.prototype.init = function () {
      ...
      if (e.find('.lg-object').hasClass('lg-has-poster') && e.find('.lg-object').is(':visible'))
        if (e.hasClass('lg-has-video')) {
          ...
          o.core.s.dynamic
            ...
            : ((t = o.core.$items.eq(o.core.index).attr('href') || o.core.$items.eq(o.core.index).attr('data-src')),
    ...
    ((o.core.s.enableSwipe && o.core.isTouch) || (o.core.s.enableDrag && !o.core.isTouch))
      ...
      o.core.$el.on('onBeforeSlide.lg.tm', function (e, i, l) {
        ...
        n = o.core.s.dynamic
          ...
          : o.core.$items.eq(l).attr('href') || o.core.$items.eq(l).attr('data-src')
        ...
        b(function () {
          for (
            ...
            try {
              ...
              f &&
                f.error('Error parsing ' + h + ' on ' + l.nodeName.toLowerCase() + (l.id ? '#' + l.id : '') + ': ' + n)
              continue
            }
            var o = new c(l, k),
              p = a.jQuery
    ...
    return (
      ...
      (g.prototype.reveal = function () {
        ...
        ;(b[c] = this.onRevealTransitionEnd),
          this.transition({ from: a.hiddenStyle, to: a.visibleStyle, isCleaning: !0, onTransitionEnd: b })
      }),
  ...
  (function (a, b) {
    ...
    return (
      ...
      (g.prototype._itemize = function (a) {
        for (
          var b = this._filterFindItemElements(a), c = this.constructor.Item, d = [], e = 0, f = b.length;
          f > e;
          e++
        ) {
          var g = b[e],
...
!(function (a) {
  ...
  (function (a, b) {
    'function' == typeof define && define.amd
      ? define(
          'packery/js/packery',
          ['classie/classie', 'get-size/get-size', 'outlayer/outlayer', './rect', './packer', './item'],
          b,
        )
      : 'object' == typeof exports
      ? (module.exports = b(
      ...
      (i.prototype._getDragEndLayoutComplete = function (b, c) {
        ...
        return function () {
          return (
            ...
            e != f
              ? !0
              : (c && (a.remove(c.element, 'is-positioning-post-drag'), (c.isPlacing = !1), c.copyPlaceRectPosition()),
                g.unstamp(b),
          ...
          (k.render = function (a, b, c) {
            ...
            if ((o !== this._time && (a += this._time - o), a >= p - 1e-7 && a >= 0))
              ...
              if (
                ...
                (this._time = 0),
                (0 !== o || (0 === q && u !== e && (u > 0 || (0 > a && u >= 0)) && !this._locked)) &&
            ...
            if (this._cycle !== w && !this._locked) {
              ...
              if (
                ...
                return
              if (
                (y && ((this._cycle = w), (this._locked = !0), (o = x ? q + 1e-4 : -1e-4), this.render(o, !0, !1)),
                (this._locked = !1),
                this._paused && !v)
              )
                return
...
;(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  var a = (_gsScope.document || {}).documentElement,
    ...
    e = function (c, d) {
      ...
      return (
        c === b &&
          (null != c.pageXOffset ? (e = 'page' + d.toUpperCase() + 'Offset') : (c = null != a[e] ? a : document.body)),
        function () {
          return c[e]
        }
      )
    ...
    h = _gsScope._gsDefine.plugin({
      ...
      init: function (a, c, d) {
        return (
          ...
          (this._tween = d),
          'object' != typeof c
            ? ((c = { y: c }), 'string' == typeof c.y && 'max' !== c.y && '=' !== c.y.charAt(1) && (c.x = c.y))
          ...
          null != c.x
            ? (this._addTween(this, 'x', this.x, g(c.x, a, 'x') - (c.offsetX || 0), 'scrollTo_x', !0),
              this._overwriteProps.push('scrollTo_x'))
            : (this.skipX = !0),
          null != c.y
            ? (this._addTween(this, 'y', this.y, g(c.y, a, 'y') - (c.offsetY || 0), 'scrollTo_y', !0),
            ...
            this.each(function () {
              ...
              r.forEach(function (e) {
                ...
                'undefined' != typeof u &&
                  ...
                  -1 != u.indexOf('right')
                    ? (i.css('left', 'auto'), i.css('right', '0px'), -1 != u.indexOf('center') && i.css('top', '40%'))
                    : -1 != u.indexOf('left center') && i.css('top', '40%'),
                  -1 != u.indexOf('bottom') &&
                    (i.css('bottom', '0px'), i.css('top', 'auto'), -1 != u.indexOf('center') && i.css('left', '40%'))),
...
;(function (a, e, d, c) {
  var b = {
    ...
    getCoords: function (f) {
      return { top: Math.round(f.offset().top) - this.options.offset }
    },
      ...
      defaults: function (e, i) {
        return (
          ...
          'undefined' == typeof psSettings
            ? ((psSettings = t.extend({}, o, i)), e.data('kool-ctb-window', psSettings))
      ...
      init: function (o) {
        ...
        return this.each(function () {
          ...
          n &&
            ...
            (t('html').attr('data-ks-initialised', 'true'), e(psSettings, t(a + ' ' + r))),
    ...
    s = {
      ...
      ksCollectLoadPageInfo: function (o, e, i, n, a) {
        ...
        s.ksLoadPage(o, e, r, n, a),
          a && (history.pushState({ url: r }, null, r), t('html').attr('data-ks-history-pushed', 'true'))
      },
      ...
      ksPositionAndPrepare: function (o, e, i, n, a) {
        ...
        if (
          ((reloadboxRightAbsolute = l.left + parseFloat(b) + d - parseFloat(u)),
          ($reloadboxIn = t('#' + n)),
                      ...
                      t &&
                        ...
                        setTimeout(function () {
                          $('html,body').animate(
                            ...
                            { queue: !1, duration: 800, easing: 'easeInOutExpo' },
                          )
                        }, 1450)
                  })
                  .attr('id', g)
